...
import { ReporterRuntime, createDefaultWriter, getEnvironmentLabels, getSuiteLabels, parseTestPlan } from "allure-js-commons/sdk/reporter";
...
export class AllureCypress {
  constructor() {
    ...
    _classPrivateFieldInitSpec(this, _startHook, (context, _ref4) => {
      ...
      var [hookPosition, hookScopeType] = getHookType(name);
      if (hookPosition) {
    ...
    _classPrivateFieldInitSpec(this, _startTest, (context, _ref6) => {
      ...
      context.test = this.allureRuntime.startTest({
        ...
        labels: [{
          ...
          value: "cypress"
        }, ...getSuiteLabels(context.suiteNames), ...metadataLabels, ...getEnvironmentLabels()]
    ...
    _classPrivateFieldInitSpec(this, _initializeSpecContext, absolutePath => {
      var specPathElements = path.relative(process.cwd(), absolutePath).split(path.sep);
      var context = {
 ...
 */
export var enableTestPlan = config => {
