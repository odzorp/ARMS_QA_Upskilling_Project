...
export var flushRuntimeMessages = () => getTestRuntime().flushMessages();
export var flushFinalRuntimeMessages = () => getTestRuntime().flushFinalMessages();
...
export var reportHookStart = hook => {
  enqueueRuntimeMessage({
...
export var reportTestStart = (test, flag) => {
  var _test$wallClockStarte;
  var x = getNamesAndLabels(Cypress.spec, test);
  if (flag) {
    x.labels.push({
      name: "reported",
      value: flag
