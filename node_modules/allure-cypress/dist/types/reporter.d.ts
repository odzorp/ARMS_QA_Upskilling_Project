...
import type { AllureCypressConfig, SpecContext } from "./model.js";
export declare class AllureCypress {
     ...
     * });
     */
    onAfterSpec: (spec: Cypress.Spec, results: CypressCommandLine.RunResult) => void;
    /**
     ...
     * });
     */
    onAfterRun: (results: CypressCommandLine.CypressFailedRunResult | CypressCommandLine.CypressRunResult) => void;
    endRun: () => void;
 ...
 */
export declare const enableTestPlan: (config: Cypress.PluginConfigOptions) => Cypress.PluginConfigOptions;
/**
