...
export declare const ALLURE_REPORT_SYSTEM_HOOK = "__allure_report_system_hook__";
export declare const ALLURE_REPORT_STEP_COMMAND = "__allure_report_step_command__";
...
export type CypressMessage = RuntimeMessage | CupressRunStart | CypressSuiteStartMessage | CypressSuiteEndMessage | CypressHookStartMessage | CypressHookEndMessage | CypressTestStartMessage | CypressCommandStartMessage | CypressCommandEndMessage | CypressTestPassMessage | CypressFailMessage | CypressTestSkipMessage | CypressTestEndMessage;
