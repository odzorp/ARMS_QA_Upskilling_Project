...
exports.enableTestPlan = exports.allureCypress = exports.AllureCypress = void 0;
...
var _failTestOrHook = /*#__PURE__*/new WeakMap();
var _passTest = /*#__PURE__*/new WeakMap();
var _skipTest = /*#__PURE__*/new WeakMap();
var _stopTest = /*#__PURE__*/new WeakMap();
var _startCommand = /*#__PURE__*/new WeakMap();
var _stopCommand = /*#__PURE__*/new WeakMap();
...
class AllureCypress {
  constructor() {
    ...
    _defineProperty(this, "onAfterSpec", (spec, results) => {
      var _results$video;
      this.endSpec(spec.absolute, (_results$video = results.video) !== null && _results$video !== void 0 ? _results$video : undefined);
    });
    /**
      ...
      messages.forEach(message => {
        ...
        switch (message.type) {
          ...
          case "cypress_test_pass":
            ...
            break;
          case "cypress_fail":
            _classPrivateFieldGet(_failTestOrHook, this).call(this, context, message);
            break;
          case "cypress_test_skip":
            _classPrivateFieldGet(_skipTest, this).call(this, context);
            break;
          case "cypress_test_end":
            _classPrivateFieldGet(_stopTest, this).call(this, context, message);
            break;
          case "cypress_command_start":
            _classPrivateFieldGet(_startCommand, this).call(this, context, message);
            break;
          case "cypress_command_end":
            _classPrivateFieldGet(_stopCommand, this).call(this, context, message);
            break;
          default:
    ...
    _classPrivateFieldInitSpec(this, _startHook, (context, _ref4) => {
      ...
      var [hookPosition, hookScopeType] = (0, _utils.getHookType)(name);
      if (hookPosition) {
        var isEach = hookScopeType === "each";
        var isAfterEach = hookPosition === "after" && isEach;
        if (!isAfterEach) {
          _classPrivateFieldGet(_emitPreviousTestScope, this).call(this, context);
        }
    ...
    _classPrivateFieldInitSpec(this, _startTest, (context, _ref6) => {
      ...
      context.test = this.allureRuntime.startTest({
        ...
        labels: [{
          ...
          value: "cypress"
        }, ...(0, _reporter.getSuiteLabels)(context.suiteNames), ...metadataLabels, ...(0, _reporter.getEnvironmentLabels)()]
      }, [context.videoScope, ...context.suiteScopes, testScope]);
    });
    _classPrivateFieldInitSpec(this, _failTestOrHook, (context, _ref7) => {
      var {
        data: {
          status,
          statusDetails
    ...
    _classPrivateFieldInitSpec(this, _skipTest, context => {
      var testUuid = context.test;
      if (testUuid) {
        this.allureRuntime.updateTest(testUuid, testResult => {
          testResult.status = _allureJsCommons.Status.SKIPPED;
          testResult.statusDetails = {
            message: "The test was skipped"
          };
        });
      }
    });
    _classPrivateFieldInitSpec(this, _stopTest, (context, _ref8) => {
      var {
        data: {
          retries,
          duration
    ...
    _classPrivateFieldInitSpec(this, _startCommand, (context, _ref9) => {
      var {
        data: {
          name,
          args
      ...
      if (rootUuid) {
        var stepUuid = this.allureRuntime.startStep(rootUuid, undefined, {
          name,
    ...
    _classPrivateFieldInitSpec(this, _stopCommand, (context, _ref10) => {
      var {
        data: {
          status,
          statusDetails,
      ...
      var stepUuid = context.commandSteps.pop();
      if (stepUuid) {
    ...
    _classPrivateFieldInitSpec(this, _initializeSpecContext, absolutePath => {
      var specPathElements = _nodePath.default.relative(process.cwd(), absolutePath).split(_nodePath.default.sep);
      var context = {
 ...
 * });
 */
exports.enableTestPlan = enableTestPlan;
